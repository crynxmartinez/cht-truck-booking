...
export const STAGE_META: Array<{
  ...
  { stage: Stage.AWAITING_APPROVAL, label: 'Needs your signature', dot: '#d6001c', blurb: 'Renter has signed. Counter-sign to confirm the booking.' },
...
export const STAGE_LABEL: Record<Stage, string> = {
  ...
  AWAITING_APPROVAL: 'Needs your signature',
  CONFIRMED: 'Confirmed',
